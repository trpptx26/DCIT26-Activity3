...
<html>
    ...
    <link rel="stylesheet" href="ORDERINGAPPLICATION.css">
    </head>
    <body>
        <?php
        $price = "";
        ...
        <div>
            <form action="" method="post" >
                ...
                <div class ="shop">
                    <!-- BUTTONS -->
                    <img src="pink_slides.jpg" height = "250" width = "250px"></img>
                    <input name="pink_slides" type="submit" value="PINK SLIDES"><br>
                    <img src="black_sandals.jpg" height = "250" width = "250px"></img>
                    <input name="black_sandals" type="submit" value="BLACK SANDALS"><br>
                    <img src="bnw_sneakers.jpg" height = "250" width = "250px"></img>
                    <input name="bnw_sneakers" type="submit" value="BNW SNEAKERS"><br>
                    <img src="blue_slippers.jpg" height = "250" width = "250px"></img>
                    <input name="blue_slippers" type="submit" value="BLUE SLIPPERS"><br>
                    <img src="pink_slippers.jpg" height = "250" width = "250px"></img>
                    <input name="pink_slippers" type="submit" value="PINK SLIPPERS"><br>
                    <img src="pretty_slippers.jpg" height = "250" width = "250px"></img>
                    <input name="pretty_slippers" type="submit" value="PRETTY SLIPPERS"><br>
                    <img src="red_shirt.jpg" height = "250" width = "250px"></img>
                    <input name="red_shirt" type="submit" value="RED SHIRT"><br>
                    <img src="black_shirt.jpg" height = "250" width = "250px"></img>
                    <input name="black_shirt" type="submit" value="BLACK SHIRT"><br>
                    <img src="usb_charger.jpg" height = "250" width = "250px"></img>
